package com.eukalyptus.eukalyptusplayer.service;
...
import com.eukalyptus.eukalyptusplayer.enums.PlaybackStatus;
...
public class MusicService extends Service implements MediaPlayer.OnCompletionListener,
    ...
    private int repeatMode = 1; //1-once 2-list once 3-repeat all
...
//        buildNotification(PlaybackStatus.PLAYING);
    ...
    public void onCompletion(MediaPlayer mp) {
        ...
        switch (repeatMode){
            case 1:
                if(audioIndex < currentPlay.size() - 1) {
                    skipToNext();
//                    buildNotification(PlaybackStatus.PAUSED);
                }
                break;
...
//        mediaPlayer.reset();
    ...
    private void buildNotification(PlaybackStatus playbackStatus) {
        ...
        Bitmap largeIcon = BitmapFactory.decodeResource(getResources(), R.drawable.default_music_image);
